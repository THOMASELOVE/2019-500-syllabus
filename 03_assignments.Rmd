...
During the semester, you will be responsible for presenting the methods and results of an observational study from the literature that uses propensity scores. Your choice of manuscript must be accepted before March 1 by Dr. Love. After you've claimed a study, you'll present it to the class in early April, and you'll also act as "second reviewer" for one of the studies selected by your colleagues.

Complete details on the OSIA work [are available here](https://github.com/THOMASELOVE/2019-500/tree/master/assignments/OSIA).
